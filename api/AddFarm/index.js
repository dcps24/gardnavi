...
module.exports = async function (context, req) {
  ...
  try {
    ...
    request.input('reko_ring', sql.NVarChar, body.reko_ring || '');

    const result = await request.query(`
      INSERT INTO Farms (name, description, municipality, address, latitude, longitude, phone, email, website, reko_ring)
      OUTPUT INSERTED.id
      VALUES (@name, @description, @municipality, @address, @latitude, @longitude, @phone, @email, @website, @reko_ring)
    `);
